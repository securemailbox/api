...
# Copy project files
${SCP} docker-compose.production.yml ${DEPLOY_USER}@${DEPLOY_TARGET}:/etc/securemailboxes/
${SCP} nginx/flaskapp_prod.conf ${DEPLOY_USER}@${DEPLOY_TARGET}:/etc/securemailboxes/nginx/
